document.addEventListener('DOMContentLoaded', () => {
  ...
  const accountWidget = profile
    ...
    : `<div class="auth-launcher" aria-label="Hesap işlemleri"><a href="/login">Giriş yap</a><a href="/register">Kayıt ol</a></div>`;

    ...
    return ThemeData(
      ...
      textTheme: baseTextTheme.copyWith(
        displayLarge: baseTextTheme.displayLarge?.copyWith(
          fontSize: 32, fontWeight: FontWeight.w700, color: POSColors.text,
        ),
        headlineLarge: baseTextTheme.headlineLarge?.copyWith(
          fontSize: 28, fontWeight: FontWeight.w700, color: POSColors.text,
        ),
        headlineMedium: baseTextTheme.headlineMedium?.copyWith(
          fontSize: 24, fontWeight: FontWeight.w700, color: POSColors.text,
        ),
        headlineSmall: baseTextTheme.headlineSmall?.copyWith(
          fontSize: 20, fontWeight: FontWeight.w600, color: POSColors.text,
        ),
        titleLarge: baseTextTheme.titleLarge?.copyWith(
          fontSize: 18, fontWeight: FontWeight.w600, color: POSColors.text,
        ),
        bodyLarge: baseTextTheme.bodyLarge?.copyWith(
          fontSize: 16, color: POSColors.text,
        ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: const TextStyle(color: POSColors.textSecondary, fontSize: 14),
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) return POSColors.greenLight;

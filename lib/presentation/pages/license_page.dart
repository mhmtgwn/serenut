      ...
      child: Column(
        children: [
          ...
          _DetailRow(
            ...
            value: isWildcard
                ? 'Sınırsız (*)'
                : '${devices.length}/${tier.deviceLimit}',
          ),
        ],
      ),
    );
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      _TierCell(
                          included: feat.$2,
                          isActive: currentTier == LicenseTier.basic),
                      _TierCell(
                          included: feat.$3,
                          isActive: currentTier == LicenseTier.pro),
                      _TierCell(
                          included: feat.$4,
                          isActive: currentTier == LicenseTier.proPlus),
                    ],
                  ),
                ),
                if (!isLast)
                  const Divider(height: 1, indent: 16, color: _kBorderColor),
              ],
            );
          }),
        ],

...
import 'orders.dart';
// import 'finance.dart'; // Geçici olarak devre dışı
...
class _HomePageState extends State<HomePage> {
  ...
  // final _financeContentKey = GlobalKey<State<FinancePage>>(); // Finance devre dışı
  ...
  late  // Widget? _financeContent; // Finance devre dışı
  ...
  void initState() {
    ...
    // _financeContent = FinancePage(key: _financeContentKey); // Finance devre dışı
  ...
  Widget getBody() {
    switch (_currentIndex) {
      ...
      case 4:
        return const Center(child: Text('Finans modülü geçici olarak devre dışı'));
      default:
        return _homeContent;
    }
  }
  ...
  Function(String)? getSearchFunction() {
    switch (_currentIndex) {
      ...
      case 3: // Müşteriler
        return (String value) {
          // Müşteri filtreleme işlemi kaldırıldı
        };
      default:
        return null;
    }
  ...
  Function()? getAddFunction() {
    switch (_currentIndex) {
      ...
      case 3: // Müşteriler
        return () {
          // Müşteri ekleme işlemi kaldırıldı
        };
      default:
        return null;
    }

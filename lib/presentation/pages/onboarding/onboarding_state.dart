...
class AdminInfo {
  ...
  AdminInfo copyWith({
    String? adminFullName, String? username, String? pin, String? pinConfirm,
    String? password, bool? biometricEnabled,
  }) => AdminInfo(
...
class InitialSettings {
  ...
  InitialSettings copyWith({
    double? defaultVat, String? defaultPrinter, bool? autoBackup,
    bool? smsNotifications, bool? stockTracking, bool? preventNegativeStock,
    bool? decimalSales,
  }) => InitialSettings(
  ...
  Map<String, dynamic> toJson() => {
    'defaultVat': defaultVat, 'defaultPrinter': defaultPrinter,
    'autoBackup': autoBackup, 'smsNotifications': smsNotifications,
    'stockTracking': stockTracking, 'preventNegativeStock': preventNegativeStock,
...
class LicenseInfo {
  ...
  LicenseInfo copyWith({
    String? licenseKey, String? licenseType,
    DateTime? expiryDate, DateTime? supportUntil,
  }) => LicenseInfo(
...
class OnboardingState {
  ...
  OnboardingState copyWith({
    BusinessInfo? business, AdminInfo? admin,
    InitialSettings? settings, LicenseInfo? license,
  }) => OnboardingState(
  ...
  factory OnboardingState.fromJson(Map<String, dynamic> j) => OnboardingState(
    business: BusinessInfo.fromJson(j['business'] as Map<String, dynamic>? ?? {}),
    admin:    AdminInfo.fromJson(j['admin']    as Map<String, dynamic>? ?? {}),
    settings: InitialSettings.fromJson(j['settings'] as Map<String, dynamic>? ?? {}),
    license:  LicenseInfo.fromJson(j['license']  as Map<String, dynamic>? ?? {}),
  );
}
...
class OnboardingPersistence {
  ...
  Future<void> saveStep(int step) =>
      _prefs.setInt(_kOnboardingStepKey, step);

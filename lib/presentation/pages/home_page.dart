                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSystemTrustPanel(context, ref),
                        const SizedBox(height: 16),
...
// ── Recent Alerts Provider & Stream Builders ──────────────────────────────────
      ...
      children: [
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            final int crossCount = isWide ? 6 : 3;
            
            // Grid spacing parameters
            const double spacing = 12;
            final double itemWidth = (width - (crossCount - 1) * spacing) / crossCount;
            const double desiredHeight = 82;
            final double aspectRatio = itemWidth / desiredHeight;
            ...
            return GridView.count(
              ...
              children: [
                ...
                _QuickActionBtn(
                  ...
                  color: const Color(0xFF3B82F6),
                  onTap: () => _showFastCollectionSheet(context),
                ),
                _QuickActionBtn(
                  label: 'Siparişler',
...
Widget _buildAlertStream(BuildContext context, WidgetRef ref) {
...
// ── Fast Collection sheet functions ───────────────────────────────────────────

void _showFastCollectionSheet(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) => Padding(
      ...
      child: const _FastCollectionBottomSheet(),
    ),
  );
}

class _FastCollectionBottomSheet extends ConsumerStatefulWidget {
  const _FastCollectionBottomSheet();

  @override
  ConsumerState<_FastCollectionBottomSheet> createState() => _FastCollectionBottomSheetState();
}

class _FastCollectionBottomSheetState extends ConsumerState<_FastCollectionBottomSheet> {

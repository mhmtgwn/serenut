  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          _SalesTab(range: _selectedRange),
          ...
          children: [
            ...
            categoryVal.when(
              data: (cats) => cats.isEmpty
                  ? _emptyState('Kategori verisi yok')
                  : _buildCategoryList(cats),
              loading: () => const Center(child: CircularProgressIndicator()),
              error: (e, _) => _errorCard('Kategori yüklenemedi: $e'),
            ),
          ],
        ),
      ),
    ...
    return GridView.count(
      ...
      children: [
        ...
        _MetricCard(
          ...
          subtitle: 'Toplam Borç: ${_fmt(s.totalDebt)} TL',
        ),
      ],
    );
  }

...
class ReleaseManagerService {
  ...
  static List<String> _resolveTrustedModuli(
    ...
    if (result.isEmpty) {
      return const <String>[
        '',
        '',
      ];
    }
    return result;
  }

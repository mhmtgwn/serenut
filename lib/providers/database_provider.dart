...
final sqliteProductRepositoryProvider =
...
final sqliteCustomerRepositoryProvider =
...
final sqliteSaleRepositoryProvider =
    FutureProvider<ISaleRepository>((ref) async {
  final gateway = ref.watch(dbGatewayProvider);
...
final sqliteOrderRepositoryProvider =
    FutureProvider<IOrderRepository>((ref) async {
  final gateway = ref.watch(dbGatewayProvider);

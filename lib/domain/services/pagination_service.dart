...
class PaginationService<T> {
  final Future<List<T>> Function(int offset, int limit, String? searchQuery)
      _dataLoader;
  final int _pageSize;
  ...
  PaginationService({
    required Future<List<T>> Function(
            int offset, int limit, String? searchQuery)
        dataLoader,
    int pageSize = 20,
  ...
  Future<void> loadNextPage() async {
    ...
    try {
      ...
      final newItems =
          await _dataLoader(offset, _pageSize, _currentSearchQuery);

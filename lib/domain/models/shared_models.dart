...
class SharedProduct {
  ...
  bool get isValid => barcode.trim().length >= 5 && name.trim().isNotEmpty && category.trim().isNotEmpty;
}
...
class SharedPrice {
  ...
  bool get isValid => barcode.trim().length >= 5 && marketName.trim().isNotEmpty && price > 0;
}

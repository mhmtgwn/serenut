...
enum Permission {
  ...
  // Customers (4)
  customersView(
      'customers:view', 'View customers', PermissionCategory.customers),
  customersCreate(
      'customers:create', 'Create customer', PermissionCategory.customers),
  customersEdit(
      'customers:edit', 'Edit customer', PermissionCategory.customers),
  customersDelete(
      'customers:delete', 'Delete customer', PermissionCategory.customers),

  // Payments (3)
  paymentsView('payments:view', 'View payments', PermissionCategory.payments),
  paymentsRecord(
      'payments:record', 'Record payment', PermissionCategory.payments),
  paymentsReverse(
      'payments:reverse', 'Reverse payment', PermissionCategory.payments),

  // Inventory (3)
  inventoryView(
      'inventory:view', 'View inventory', PermissionCategory.inventory),
  inventoryAdjust(
      'inventory:adjust', 'Adjust stock', PermissionCategory.inventory),
  inventoryTransfer(
      'inventory:transfer', 'Transfer stock', PermissionCategory.inventory),

  // Reports (3)
  reportsView('reports:view', 'View reports', PermissionCategory.reports),
  reportsFinancial(
      'reports:financial', 'Financial reports', PermissionCategory.reports),
  reportsInventory(
      'reports:inventory', 'Inventory reports', PermissionCategory.reports),
  ...
  settingsPrinter(
      'settings:printer', 'Yazıcı Tercihleri', PermissionCategory.admin),
  settingsReceipt(
      'settings:receipt', 'Fiş Şablon Yönetimi', PermissionCategory.admin),
  settingsUsers(
      'settings:users', 'Kullanıcı Yetkilendirme', PermissionCategory.admin),
  settingsFinance(
      'settings:finance', 'Finans & Cari Ayarlar', PermissionCategory.admin),
  settingsAudit(
      'settings:audit', 'Log & Audit İzleme', PermissionCategory.admin),
  settingsDatabase('settings:database', 'Veritabanı Bakım & Sağlık',
      PermissionCategory.admin),
  settingsRecovery(
      'settings:recovery', 'Veri Kurtarma', PermissionCategory.admin),
  settingsLicense(
      'settings:license', 'Lisans & Abonelik', PermissionCategory.admin);

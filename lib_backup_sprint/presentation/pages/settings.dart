...
class _SettingsPageState extends State<SettingsPage> {
    ...
    try {
      ...
      setState(() {
        ...
        _smsNotificationsEnabled =
            prefs.getBool('sms_notifications_enabled') ?? false;
        ...
        _footerNote = prefs.getString('footer_note') ??
            'Bizi tercih ettiğiniz için teşekkür ederiz!';
        _logoPath = prefs.getString('logo_path');
      });
    } catch (e) {
      DebugConfig.logError('Ayarlar yüklenirken hata', e);
    } finally {
      if (mounted) {
  ...
  Widget _buildSettingsTile({
    ...
    final iconColor = isDarkMode
        ...
        : AppTheme.lightTextColor; // Tema metin rengini kullanıyoruz
...
// Tema kart rengini kullanıyoruz
  ...
  Widget build(BuildContext context) {
    ...
    final inactiveTrackColor =
        isDarkMode ? AppTheme.darkBorderColor : AppTheme.lightBorderColor;
                    ...
                    _buildSettingsTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const DevicesPageNew(),
                          ),
                        );
                      },
                      showDivider: false,
                ...
                _buildSettingsCard(
                  children: [
                    ...
                    _buildSettingsTile(
                      ...
                      onTap: () =>
                          Navigator.pushNamed(context, '/sms-settings'),
                      showDivider: false,
                    ),
                  ],
                ),
                ...
                _buildSettingsCard(
                  children: [
                    ...
                    _buildSettingsTile(
                      ...
                      onTap: () => Navigator.pushNamed(
                          context, '/language-currency-settings'),
                      showDivider: false,
                    ),
                  ],
                ),
                ...
                _buildSettingsCard(
                  children: [
                    _buildSettingsTile(
                      ...
                      title: 'Güvenlik',
                      subtitle: 'PIN ve güvenlik ayarları',
                      onTap: () =>

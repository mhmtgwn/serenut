...
# Look for v1.3.7 release artifacts (build 84)
apk_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.7.apk",
    "/var/www/serenut/server/releases/app-release-1.3.7+84.apk",
    "/var/www/serenut/server/releases/app-release.apk"
]

win_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.7.exe",
    "/var/www/serenut/server/releases/SerenutOSSetup-1.3.7+84.exe",
...
os.system(f"cp '{apk_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.7.apk")
os.system(f"cp '{win_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.7.exe")
...
# Clean semantic version 1.3.7 without internal build number '+' for public UI and API
insert_db("rel-apk-13784", "1.3.7", "android", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.7.apk", apk_size, apk_chk, apk_sig, "Serenut OS v1.3.7 — UI/UX iyilestirmeleri")
insert_db("rel-win-13784", "1.3.7", "windows", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.7.exe", win_size, win_chk, win_sig, "Serenut OS v1.3.7 — UI/UX iyilestirmeleri")

print("ALL_RELEASES_1.3.7_BUILD84_PUBLISHED_SUCCESSFULLY")

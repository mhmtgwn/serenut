...
# Look for v1.3.6 release artifacts
apk_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.6.apk",
    "/var/www/serenut/server/releases/app-release-1.3.6+82.apk",
    "/var/www/serenut/server/releases/app-release.apk"
]

win_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.6.exe",
    "/var/www/serenut/server/releases/SerenutOSSetup-1.3.6+82.exe",
...
os.system(f"cp '{apk_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.6.apk")
os.system(f"cp '{win_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.6.exe")
...
# Clean semantic version 1.3.6 without internal build number '+' for public UI and API
insert_db("rel-apk-13082", "1.3.6", "android", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.6.apk", apk_size, apk_chk, apk_sig, "Serenut OS v1.3.6 — Kategori olusturma KDV girisi istege bagli yapildi, Karma odeme ekran kaymasi ve Nakit para ustu dinamik hesaplayici eklendi")
insert_db("rel-win-13082", "1.3.6", "windows", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.6.exe", win_size, win_chk, win_sig, "Serenut OS v1.3.6 — Kategori olusturma KDV girisi istege bagli yapildi, Karma odeme ekran kaymasi ve Nakit para ustu dinamik hesaplayici eklendi")

print("ALL_RELEASES_1.3.6_PUBLISHED_SUCCESSFULLY")

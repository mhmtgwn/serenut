...
# Look for v1.3.0+76 or v1.3.0 release artifacts
apk_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.0.apk",
    "/var/www/serenut/server/releases/app-release-1.3.0+76.apk",
    "/var/www/serenut/server/releases/app-release.apk"
]

win_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.0.exe",
    "/var/www/serenut/server/releases/SerenutOSSetup-1.3.0+76.exe",
...
os.system(f"cp '{apk_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.0.apk")
os.system(f"cp '{win_path}' /var/www/serenut-api/releases/SerenutOS-v1.3.0.exe")
...
# Clean semantic version 1.3.0 without internal build number '+' for public UI and API
insert_db("rel-apk-13076", "1.3.0", "android", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.0.apk", apk_size, apk_chk, apk_sig, "Serenut OS v1.3.0 — Siparis etiketi: musteri no, eski borc, odeme durumu gosteriliyor")
insert_db("rel-win-13076", "1.3.0", "windows", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.0.exe", win_size, win_chk, win_sig, "Serenut OS v1.3.0 — Siparis etiketi: musteri no, eski borc, odeme durumu gosteriliyor")

print("ALL_RELEASES_1.3.0_PUBLISHED_SUCCESSFULLY")

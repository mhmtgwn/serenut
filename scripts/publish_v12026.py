...
apk_path = "/var/www/serenut/server/releases/app-release-1.2.0+26.apk"
win_path = "/var/www/serenut/server/releases/SerenutOSSetup-1.2.0+26.exe"
...
os.system("cp /var/www/serenut/server/releases/app-release-1.2.0+26.apk /var/www/serenut-api/releases/app-release-1.2.0+26.apk")
os.system("cp /var/www/serenut/server/releases/SerenutOSSetup-1.2.0+26.exe /var/www/serenut-api/releases/SerenutOSSetup-1.2.0+26.exe")
...
insert_db("rel-apk-12026", "1.2.0+26", "android", "stable", "/var/www/serenut-api/releases/app-release-1.2.0+26.apk", apk_size, apk_chk, apk_sig, "Windows batch runner yol duzeltmesi")
insert_db("rel-win-12026", "1.2.0+26", "windows", "stable", "/var/www/serenut-api/releases/SerenutOSSetup-1.2.0+26.exe", win_size, win_chk, win_sig, "Windows batch runner yol duzeltmesi")
print("ALL_RELEASES_1.2.0+26_PUBLISHED_SUCCESSFULLY")

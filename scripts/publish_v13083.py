...
# Look for v1.3.6 release artifacts (build 83)
apk_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.6.apk",
    "/var/www/serenut/server/releases/app-release-1.3.6+83.apk",
    "/var/www/serenut/server/releases/app-release.apk"
]

win_candidates = [
    "/var/www/serenut/server/releases/SerenutOS-v1.3.6.exe",
    "/var/www/serenut/server/releases/SerenutOSSetup-1.3.6+83.exe",
...
insert_db("rel-apk-13083", "1.3.6", "android", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.6.apk", apk_size, apk_chk, apk_sig, "Serenut OS v1.3.6 — Hata duzeltmeleri ve performans iyilestirmeleri")
insert_db("rel-win-13083", "1.3.6", "windows", "stable", "/var/www/serenut-api/releases/SerenutOS-v1.3.6.exe", win_size, win_chk, win_sig, "Serenut OS v1.3.6 — Hata duzeltmeleri ve performans iyilestirmeleri")

print("ALL_RELEASES_1.3.6_BUILD83_PUBLISHED_SUCCESSFULLY")

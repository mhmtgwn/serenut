...
apk_path = "/var/www/serenut/server/releases/app-release-1.2.0+24.apk"
win_path = "/var/www/serenut/server/releases/SerenutOSSetup-1.2.0+24.exe"
...
os.system("cp /var/www/serenut/server/releases/app-release-1.2.0+24.apk /var/www/serenut-api/releases/app-release-1.2.0+24.apk")
os.system("cp /var/www/serenut/server/releases/SerenutOSSetup-1.2.0+24.exe /var/www/serenut-api/releases/SerenutOSSetup-1.2.0+24.exe")
...
insert_db("rel-apk-12024", "1.2.0+24", "android", "stable", "/var/www/serenut-api/releases/app-release-1.2.0+24.apk", apk_size, apk_chk, apk_sig, "Windows sessiz kurulum ve otomatik baslatma iyilestirmesi")
insert_db("rel-win-12024", "1.2.0+24", "windows", "stable", "/var/www/serenut-api/releases/SerenutOSSetup-1.2.0+24.exe", win_size, win_chk, win_sig, "Windows sessiz kurulum ve otomatik baslatma iyilestirmesi")
print("ALL_RELEASES_1.2.0+24_PUBLISHED_SUCCESSFULLY")

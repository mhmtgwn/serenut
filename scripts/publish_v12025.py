...
apk_path = "/var/www/serenut/server/releases/app-release-1.2.0+25.apk"
win_path = "/var/www/serenut/server/releases/SerenutOSSetup-1.2.0+25.exe"
...
os.system("cp /var/www/serenut/server/releases/app-release-1.2.0+25.apk /var/www/serenut-api/releases/app-release-1.2.0+25.apk")
os.system("cp /var/www/serenut/server/releases/SerenutOSSetup-1.2.0+25.exe /var/www/serenut-api/releases/SerenutOSSetup-1.2.0+25.exe")
...
insert_db("rel-apk-12025", "1.2.0+25", "android", "stable", "/var/www/serenut-api/releases/app-release-1.2.0+25.apk", apk_size, apk_chk, apk_sig, "Siparis esitleme ve arayuz yenileme duzeltmeleri")
insert_db("rel-win-12025", "1.2.0+25", "windows", "stable", "/var/www/serenut-api/releases/SerenutOSSetup-1.2.0+25.exe", win_size, win_chk, win_sig, "Siparis esitleme ve arayuz yenileme duzeltmeleri")
print("ALL_RELEASES_1.2.0+25_PUBLISHED_SUCCESSFULLY")

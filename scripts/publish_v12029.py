...
apk_path = "/var/www/serenut/server/releases/app-release-1.2.0+29.apk"
win_path = "/var/www/serenut/server/releases/SerenutOSSetup-1.2.0+29.exe"
...
os.system("cp /var/www/serenut/server/releases/app-release-1.2.0+29.apk /var/www/serenut-api/releases/app-release-1.2.0+29.apk")
os.system("cp /var/www/serenut/server/releases/SerenutOSSetup-1.2.0+29.exe /var/www/serenut-api/releases/SerenutOSSetup-1.2.0+29.exe")
...
insert_db("rel-apk-12029", "1.2.0+29", "android", "stable", "/var/www/serenut-api/releases/app-release-1.2.0+29.apk", apk_size, apk_chk, apk_sig, "Clean Header UX & Compact Status Indicator Update")
insert_db("rel-win-12029", "1.2.0+29", "windows", "stable", "/var/www/serenut-api/releases/SerenutOSSetup-1.2.0+29.exe", win_size, win_chk, win_sig, "Clean Header UX & Compact Status Indicator Update")
print("ALL_RELEASES_1.2.0+29_PUBLISHED_SUCCESSFULLY")

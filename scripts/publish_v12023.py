...
apk_path = "/var/www/serenut/server/releases/app-release-1.2.0+23.apk"
win_path = "/var/www/serenut/server/releases/SerenutOSSetup-1.2.0+23.exe"
...
insert_db("rel-apk-12023", "1.2.0+23", "android", "stable", "/var/www/serenut-api/releases/app-release-1.2.0+23.apk", apk_size, apk_chk, apk_sig, "Sistem ve WebSocket esitleme iyilestirmeleri")
insert_db("rel-win-12023", "1.2.0+23", "windows", "stable", "/var/www/serenut-api/releases/SerenutOSSetup-1.2.0+23.exe", win_size, win_chk, win_sig, "Sistem ve WebSocket esitleme iyilestirmeleri")
print("ALL_RELEASES_1.2.0+23_PUBLISHED_SUCCESSFULLY")
